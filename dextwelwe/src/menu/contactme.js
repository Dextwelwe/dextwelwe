...
export default function Contactme({contact, set}) {
  ...
  return (
    ...
    <div ref={text} className='textContentContactMe'>
      ...
      <h2 className='fontColor px-2 m-0'>Contact me</h2>
     ...
     <a className='textLink' target="_blank" rel="noopener noreferrer" href='https://www.linkedin.com/in/danil-moskalenko-a94391282/'><span><img src={li} alt='linkedin' className='imgLogo'></img></span></a>
